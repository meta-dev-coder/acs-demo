...
try {
 ...
 const point=await page.evaluate(id=>{const e=signals.trafficSignalById.get(id);const p=C.SceneTransforms.worldToWindowCoordinates(v.scene,e.position.getValue());return{x:p.x,y:p.y-15};},id);
