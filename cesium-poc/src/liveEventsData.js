...
export const LIVE_EVENT_LABELS = Object.freeze({ INCIDENT: 'Incident', CLOSURE: 'Closure', CONSTRUCTION: 'Construction', CONGESTION: 'Congestion', DISABLED: 'Disabled vehicle' });
