...
test('layers whose module reports no count simply have none', () => {
  ...
  const expected = ['lighting', ...LIGHTING_CATEGORIES.map(c => c.id), 'cameras', 'closures', 'construction', 'congestion', 'disabled-vehicles', 'gantries', 'incidents', 'lane-barriers', 'message-signs', 'signals', 'structures',
